            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-footer-widget">
                    <div class="footer-logo">
                        <a href="index.html"><img class="w-75" src="img/logo/logo_iedj.png" alt=""></a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-7 col-12">
                <span>Copyright &copy; IED JERUSALEN 2022.All right reserved.Created by <a href="#">LiboritoSoftware</a></span>
            </div>
