                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-7 col-md-5 d-none d-lg-block d-md-block">
                            <span>¿Tiene alguna pregunta? +968 547856 254</span>
                        </div>
                        <div class="col-lg-5 col-md-7 col-12">
                            <div class="header-top-right">
                                <div class="content"><a href="#"><i class="zmdi zmdi-account"></i> Mi cuenta</a>
                                    <!-- <ul class="account-dropdown">
                                        <li><a href="login-register.html">Mi cuenta</a></li>
                                    </ul> -->
                                </div>
                            </div>
                        </div>
